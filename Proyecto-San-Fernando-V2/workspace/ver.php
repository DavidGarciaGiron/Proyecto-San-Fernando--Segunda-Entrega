...
<html>
	...
	<style>
      ...
      margin-top:0;
	    ...
	    padding-bottom:30px;
	    overflow: auto;
	    background-image: url(/img/fondoTec.png);
	...
	<body>
        ...
        <div class="modal fade md1" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
          <div class="modal-content">
          <div class="modal-body">
            <form role="form" method="post" action="php/agregar3.php">
              <h1>Ingrese un Nuevo Registro</h1>
                    ...
                    <input type="text" class="feedback-input" name="precio" required placeholder="Ingrese el Precio">
